 ...
 *
 * @author Dr. Gallagher
 * @version 1.0 Created 2 Mar 2001 Summary of Modifications 3 Dec 2009 - DMG -
 * changed type for data stored in TFNode to Item and changed necessary methods
 * to deal with Item instead of Object Description: The basic node for a 2-4
 * tree. Contains an array of Items, an array of references to children TFNodes,
 * a pointer to a parent TFNode, and a count of how many Items are stored in the
 * node.
 */
public class TFNode {
